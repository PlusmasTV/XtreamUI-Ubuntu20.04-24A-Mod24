...
rDownloadURL = {"main": "https://bitbucket.org/plusxtream/24a-mods24/main_xui_xoceunder.tar.gz", "sub": "https://bitbucket.org/plusxtream/24a-mods24/sub_xui_xoceunder.tar.gz"}
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://bitbucket.org/plusxtream/24a-mods24/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://bitbucket.org/plusxtream/24a-mods24/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/plusxtream/24a-mods24/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://bitbucket.org/plusxtream/24a-mods24/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
